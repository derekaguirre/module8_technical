...
class CANBusReader:
    ...
    def start_live_feed(self) -> bool:
        ...
        dec_file = open('DecodedPackets.txt', 'w')
        ...
        #self.can_decode = subprocess.Popen(['candump vcan0,0x255:0x7FF,0x201:0x7FF,0x35E:0x7FF,0x296:0x7FF,0x158:0x7FF,0x13C:7FF,0x1AB:0x7FF,0x1D0:0x7FF,0x1A3:0x7FF,0x221:0x7FF,0x300:0x7FF,0x516:0x7FF,0x200:0x7FF,0x221:0x7FF,0x184:0x7FF,0x1C2:7FF,0x14A:0x7FF | python3 -m cantools decode honda.dbc'], shell=True, stdout=dec_file, preexec_fn=os.setsid) # Create background decoding process
        self.can_decode = subprocess.Popen(['candump vcan0,0x255:0x7FF,0x201:0x7FF,0x35E:0x7FF,0x296:0x7FF,0x158:0x7FF,0x13C:7FF,0x1AB:0x7FF,0x1D0:0x7FF,0x1A3:0x7FF,0x221:0x7FF,0x300:0x7FF,0x516:0x7FF,0x200:0x7FF,0x221:0x7FF,0x184:0x7FF,0x1C2:7FF,0x14A:0x7FF | python3 -m cantools decode honda.dbc'],shell=True, preexec_fn=os.setsid)
        return True
